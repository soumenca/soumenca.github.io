...
research_cards=[('01','Neuroimaging & neurological disease','Structural and diffusion MRI, epilepsy lesion detection and imaging biomarkers of neurodegeneration.'),('02','Occupational lung disease & thoracic imaging','Quantitative CT and the relationship between lung structure, disease and pulmonary function.'),('03','Research design & delivery','Study design, clinical data preparation, reference standards, method development and validation.')]
cards=''.join(f'<a class="theme-card" href="research.html#{'delivery-title' if i==3 else 'theme-'+str(i)}"><span class="number">{n}</span><h3>{esc(t)}</h3><p>{esc(d)}</p><span class="card-link">Explore theme <span aria-hidden="true">↗</span></span></a>' for i,(n,t,d) in enumerate(research_cards,1))
...
page('consulting.html','Consulting & Training','Specialist research consulting, imaging AI evaluation and tailored training with Soumen Ghosh. Discuss your project or arrange delivery of the Clinical AI course.',consulting)
